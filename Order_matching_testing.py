...
class TestOrderMatchingFunction(TestCase):
    def test_borrow_list_no_interest_rate(self):
        expected = [[['Lending', 20000, 4.1],
                    ...
                    ['Borrowing', 500, 5.1],
                    ['Borrowing', 10000, 6]]]
        returned = order_matching(['Borrowing', 2500, 3.5], orders)
    ...
    def test_lending_list_no_interest_rate(self):
        expected = [[['Lending', 2500, 3.5],
                    ...
                    ['Borrowing', 500, 5.1],
                    ['Borrowing', 10000, 6]]]
        returned = order_matching(['Lending', 2500, 3.5], orders)
        self.assertEqual(expected, returned)
    ...
    def test_borrow_list_higher_total(self):
        expected = [[['Lending', 20000, 4.1],
                    ...
                    [['Borrowing', 1000, 4.8],
                     ...
                     ['Borrowing', 500, 5.1],
                     ['Borrowing', 10000, 6]]]
        returned = order_matching(['Borrowing', 5000, 4.9], orders)
        self.assertEqual(expected, returned)
    ...
    def test_lending_list_higher_total(self):
        expected = [[['Lending', 20000, 4.1],
                    ...
                    [['Borrowing', 1000, 4.8],
                     ['Borrowing', 10000, 6]]]
        returned = order_matching(['Lending', 5000, 5.1], orders)
        self.assertEqual(expected, returned)
    ...
    def test_borrow_list_lower_total(self):
        expected = [[['Lending', 20000, 4.1],
                    ...
                    [['Borrowing', 1000, 4.8],
                     ...
                     ['Borrowing', 500, 5.1],
                     ['Borrowing', 10000, 6]]]
        returned = order_matching(['Borrowing', 500, 5.15], orders)
        self.assertEqual(expected, returned)
    ...
    def test_lending_list_lower_total(self):
        expected = [[['Lending', 20000, 4.1],
                    ...
                    ['Borrowing', 500, 5.1],
                    ['Borrowing', 10000, 6]]]
        returned = order_matching(['Lending', 500, 4.8], orders)
        self.assertEqual(expected, returned)
